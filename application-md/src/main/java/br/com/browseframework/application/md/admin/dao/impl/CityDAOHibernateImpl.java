...
@Repository(value = "cityAdminDAO")
public class CityDAOHibernateImpl extends CrudDAOHibernateImpl<Long, City> implements CityDAO {

	@Autowired
	public CityDAOHibernateImpl(@Qualifier("sessionFactoryAdmin") SessionFactory sessionFactory) {
