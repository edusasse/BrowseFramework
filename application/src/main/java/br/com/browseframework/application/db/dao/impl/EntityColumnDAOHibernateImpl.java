...
@Repository(value = "entityColumnDAO")
public class EntityColumnDAOHibernateImpl extends CrudDAOHibernateImpl<Long, EntityColumn> implements EntityColumnDAO {

	@Autowired
	public EntityColumnDAOHibernateImpl(@Qualifier("browseApplicationSessionFactory") SessionFactory sessionFactory) {
